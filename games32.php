...
<button class="btn btn-success" style="margin-right: 5%;" onclick="checkSubmit();" id="btnnxt">ยืนยัน</button>
</div>
<br/>
<div>
...
function loadAns2(){
	$.ajax({
		url:'func/game2func.php?level=<?php echo $_GET["level"];?>&at=3&num='+game2num,
...
alert("กรุณาจับคู่ให้ครบ");
				...
				$.ajax({
				url:'func/functest3.php?level=<?php echo $_GET["level"];?>&temp='+<?php echo $_GET["temp"];?>,
				success:function(){
